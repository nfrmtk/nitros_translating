...
#define DOCTEST_INTERNAL_ERROR(msg)                                                                \
    ...
    String::size_type String::rfind(char ch, size_type pos) const {
        const char* begin = c_str();
        const char* it = begin +min(pos, size() - 1);
...
// =================================================================================================
        ...
        struct ConsoleReporter : public IReporter
        {
            ...
            void test_run_end(const TestRunStats& p) override {
                ...
                auto totwidth = int(std::ceil(log10((max(p.numTestCasesPassingFilters, static_cast<unsigned>(p.numAsserts))) + 1)));
                auto passwidth = int(std::ceil(log10((max(p.numTestCasesPassingFilters - p.numTestCasesFailed, static_cast<unsigned>(p.numAsserts - p.numAssertsFailed))) + 1)));
                auto failwidth = int(std::ceil(log10((max(p.numTestCasesFailed, static_cast<unsigned>(p.numAssertsFailed))) + 1)));
